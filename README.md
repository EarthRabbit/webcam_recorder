...
3. Then your web camera will start recording. ![img](data/Running.png)
4. If you want to stop recording for a while, just press spacebar. ![img](..data/preview.png) Do the same to resume recording.
